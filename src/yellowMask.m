...
shiftVec = [0.016559 -0.001061 0.403337];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [0.009994 -1.084796 0.000000 0.493188;
    0.731313 0.014540 0.119252 -0.571115;
    0.102322 0.002034 -0.852317 9.085217;
...
hPoints(1).data = [0.023896 -0.193171;
    -0.002976 -0.347708;
    0.185125 -0.461931;
    0.354032 -0.344349];
